...
const MEMBERS_DATA: Member[] = [
  ...
  },
  {
    ...
    address: "Director General, Institute for Defence Studies and Analyses",
    profile: ""
  },
  {
    sNo: 4,
  ...
  {
    sNo: 8,
    name: "Joint Secretary (A&A)",
    address: "Ministry of Culture, Room No.- 332, C-Wing, Third floor, Shastri Bhawan, New Delhi - 110001",
    profile: ""
  }
];

export default function ExecutiveCouncilMembers() {
        ...
        <div className="mb-8 flex items-end justify-between border-b border-gray-200/50 pb-4">
          <div className="text-left">
            ...
            <h2 className={`${spectral.className} text-2xl sm:text-3xl md:text-4xl font-bold text-[#052356] tracking-tight`}>
              Members of the <span className="text-[#052356]">Executive Council</span>
            </h2>
          </div>
