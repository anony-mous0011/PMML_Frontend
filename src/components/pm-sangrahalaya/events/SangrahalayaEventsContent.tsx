...
interface SangrahalayaEvent {
  id: string;
  title: string;
  category: 'exhibition' | 'lecture' | 'workshop' | 'celebration';
  date: string;
  day: string;
  monthYear: string;
  time: string;
...
const EVENTS_DATA: SangrahalayaEvent[] = [
  {
    id: 'e1',
    title: "Digital Democracy: Reliving India's General Elections",
    category: 'exhibition',
    date: '2026-07-15',
    day: '15',
    monthYear: 'Jul, 2026',
    time: '10:00 am - 6:00 pm',
    venue: 'Gallery 4, Building 2, Pradhanmantri Sangrahalaya',
    description: 'An immersive digital exhibition showcasing the monumental scale, planning, and historical evolution of democratic elections in independent India.',
    image: '/pms img-3.png',
  },
  {
    id: 'e2',
    title: 'Interactive History: Youth & Leadership Workshop',
    category: 'workshop',
    date: '2026-07-28',
    day: '28',
    monthYear: 'Jul, 2026',
    time: '11:00 am - 1:30 pm',
    venue: 'Anubhuti Zone, Building 2',
  ...
  },
  {
    ...
    venue: 'Building 2 Facade, Teen Murti Estate',
    description: 'A special thematic presentation of the Sound & Light show honoring the bravery, strategic decisions, and sacrifices of the Indian Armed Forces.',
    image: '/light-sound.png',
  },
  {
    id: 'e4',
    title: 'Letters of Leadership: Robotic Calligraphy Exhibit',
    category: 'exhibition',
    date: '2026-06-25',
    day: '25',
    monthYear: 'Jun, 2026',
    time: '10:00 am - 6:00 pm',
    venue: 'Ground Floor Foyer, Building 1',
    description: 'A captivating exhibition displaying personal letters, diaries, and drafts of former Prime Ministers, recreated live using precision robotic replication.',
    image: '/robotic.png',
  },
  {
    id: 'e5',
    title: 'Sovereignty & Security: The Pokhran Milestone',
    category: 'lecture',
    date: '2026-06-18',
    day: '18',
    monthYear: 'Jun, 2026',
    time: '2:30 pm - 4:30 pm',
    venue: 'Seminar Room 1, Nehru Memorial Library',
...
export default function SangrahalayaEventsContent() {
      ...
      <section className="w-full py-10 lg:py-12 bg-white text-left">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-row flex-wrap items-center justify-start gap-2.5 sm:gap-4 md:gap-6 mb-8 border-b border-solid border-slate-200 pb-0 w-full">
            {TABS.map((tab) => {
              const isActive = tab.id === 'sangrahalaya';
              return (
                <Link
                  key={tab.id}
                  href={tab.href}
