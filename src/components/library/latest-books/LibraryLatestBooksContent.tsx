...
const LATEST_BOOKS_DOCS: BookListDoc[] = [
  {
    id: "lb-1",
    title: "Latest Books for Display Board (1-6, January-March 2025) List-I",
    year: 2025,
    size: "1.20 MB",
    type: "PDF",
    url: "#"
  ...
  {
    id: "lb-2",
    title: "Latest Books for Display Board (7-12, April-June 2025) List-II",
    year: 2025,
    size: "1.50 MB",
    type: "PDF",
    url: "#"
  ...
  {
    id: "lb-3",
    title: "Latest Books for Display Board (13-18, July-September 2025) List-I",
    year: 2025,
    size: "1.10 MB",
    type: "PDF",
    url: "#"
  ...
  {
    id: "lb-4",
    title: "Latest Books for Display Board 19-24, October-December 2025) List-II",
    year: 2025,
    size: "1.40 MB",
    type: "PDF",
    url: "#"
...
export default function LibraryLatestBooksContent() {
  ...
  const processedDocs = useMemo(() => {
    let result = LATEST_BOOKS_DOCS.filter((doc) =>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="relative md:col-span-2">
              <input
                type="text"
                placeholder="Search latest books..."
                value={searchQuery}
